            ...
            <div class="col-sm-4">
                <form  method="POST" action="#" >
                    ...
                    <div alight="left">
                        ...
                        <input type="text" class="form-control" placeholder="Average_Track_Speed_Limit" name="Average_Track_Speed_Limit" id="Average_Track_Speed_Limit" value="<%= rs.getInt("Average_Track_Speed_Limit")%>" required >
                    </div>
                    <div alight="left">
                        <label class="form-label">Station start ID</label>
                        <input type="text" class="form-control" placeholder="Station_start_ID" name="Station_start_ID" id="Station_start_ID" value="<%= rs.getInt("Station_start_ID")%>" required >
                    </div>
