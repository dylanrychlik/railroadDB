...
<%@page import="Backend.*" %> 
<!DOCTYPE html>
<h1>Number of track destinations in table group by city having an ID greater than 5:</h1>
</br>
<div class="row">
    <div class="col-sm-4">
                ...
                <table id="tbl-Countstation" class="table table-responsive table-bordered" cellpadding ="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th>Count:<br></th>
                            <th>Station destination ID:<br></th>
