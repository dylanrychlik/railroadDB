...
<%
    ...
    if (request.getParameter("submit") != null) {
        ...
        track_destination.Delete(Track_ID);
...
<html>
    ...
    <body>
        <h1>Track destination Delete</h1>
            ...
            <div class="col-sm-4">
                <form  method="POST" action="#" >
                    ...
                    <div alight="left">
                        ...
                        <input type="text" class="form-control" placeholder="Station_destination_ID" name="Station_destination_ID" value="<%= rs.getInt("Station_destination_ID")%>" id="course" required >
                    </div>             
